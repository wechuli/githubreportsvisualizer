...
console.log(
  "actionsStorage test:",
  actionsStorage.test("github actions - storage")
);
console.log(
  "actionsMinutes test:",
  actionsMinutes.test("github actions - storage")
);

console.log("\nTesting GitHub Actions - Linux:");
console.log(
  "actionsStorage test:",
  actionsStorage.test("github actions - linux")
);
console.log(
  "actionsMinutes test:",
  actionsMinutes.test("github actions - linux")
);
